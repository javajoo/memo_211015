		...
		<div class="h-50 m-5">
			<table class="sign-up-table table">
						...
						<div class="d-flex">
							...
							<div class="pl-3">
								<button type="button" id="loginIdCheckBtn"
									class="btn-success form-control col-4">중복확인</button>
							</div>
						</div> <!-- 아이디 체크 결과(모두 숨겨놓는다)div 안의 class에 속성넣어줘야 한다!!!! -->
						<div id="idCheckLength"
							class="small text-primary font-weight-bold d-none">ID를 4자
							이상 입력 해주세요.</div>
						<div id="isCheck"
							class="small text-success font-weight-bold d-none">사용 가능한
							아이디 입니다.</div>
						<div id="isCheckDupliceted"
							class="small text-danger font-weight-bold d-none">중복된 아이디
							입니다.</div>
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="password" id="confirmPassword"
						name="confirmPassword" class="form-control" placeholder="비밀번호 확인">
					</td>
				</tr>
			...
			<div class="d-flex justify-content-center">
				<button type="submit" id="signUpBtn"
					class="form-control btn-info col-2">회원가입</button>
			</div>
